...
## Current Version: O_ViewDrift_Vneg_1Gap
### Version: **O_ViewDrift_Vneg_1Gap**
#### Files included
Source code:    Example/O_1Gap
...
```cpp
  const double voltage = -15e3;  // [V] = -15 kV
```
2. Added a plot of the drift of avalanche electrons and the pion track.
#### **Added:**
```cpp
#include "Garfield/ViewDrift.hh"
  ...
  // ... after avalanche loop.

  driftView.Plot();
``` 
#### **Difference after change:**

![alt text](Figures/DriftForVPos.png)
![alt text](Figures/DriftForVneg.png)
