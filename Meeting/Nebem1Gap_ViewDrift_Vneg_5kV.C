...
int main(int argc, char *argv[]) {
  ...
  constexpr bool plotField = true;
   ...
   static constexpr double fGasGapThickness = 0.025;         // cm - total gas gap thickness            250 micron = 0.25 mm = 0.025 cm
    ...
    static constexpr double fStripThickness = 0.05/10.0;         // cm - thickness of copper strips         5 mm = 0.5 cm
    static constexpr double fStripWidthX = 30.0/10;              // cm - readout strip width                28 mm = 2.8 cm
    static constexpr double fDetectorSizeX = 30.0/10.0;         // cm - detector size in X                 300 mm = 30 cm    
    static constexpr double fDetectorSizeZ = 30.0/10.0;         // cm - detector size in Z                 300 mm = 30 cm
    ...
    static constexpr double fAnodeVoltage = 2500.0;               // V - ANODE at +5 kV
    static constexpr double fCathodeVoltage = -2500.0;            // V - CATHODE at -5V
